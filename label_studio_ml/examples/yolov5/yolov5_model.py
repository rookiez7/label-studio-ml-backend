...
model_yolov5 = torch.hub.load("ultralytics/yolov5", "custom",
                                        '/data/zqh/project/label-studio-ml-backend/label_studio_ml/examples/yolov5/best.pt', trust_repo=True)

class SKUDetectorModel(LabelStudioMLBase):

    def __init__(self,
                 checkpoint_file='/data/zqh/project/label-studio-ml-backend/label_studio_ml/examples/yolov5/best.pt',
                 image_dir=None,
                 labels_file=None,
                 yolo_labels='/data/zqh/project/label-studio-ml-backend/label_studio_ml/examples/yolov5/labels.txt',
        ...
        super(SKUDetectorModel, self).__init__(**kwargs)
        global first_flag
        ...
        if yolo_labels and os.path.exists(yolo_labels):
            ...
            raise MissingYoloLables(yolo_labels)
        ...
        print(f"Load new model from {self.checkpoint_file}")
        self.model = model_yolov5
